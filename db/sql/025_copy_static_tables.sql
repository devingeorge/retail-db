...
\copy retail_core.customers(customer_id,loyalty_id,email,first_name,last_name,tier,preferred_store_id,stylist_notes,lifetime_value_band,created_at) FROM :'customers_csv' WITH (FORMAT csv, HEADER true)
